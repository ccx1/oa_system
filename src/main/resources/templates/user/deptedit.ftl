...
<body style="background-color: #ecf0f5;">
	<div class="row" style="padding-top: 10px;">
		...
		<div class="col-md-10 text-right">
			<a href="javascript:window.top.changepath('test2');"><span class="glyphicon glyphicon-home"></span> 首页</a> >
			...
			<div class="bgc-w box">
				<form action="deptedit" method="post" onsubmit="return check();">
					...
					<div class="box-header">
						<h3 class="box-title">
							<a href="javascript:window.top.history.back();" class="label label-default" style="padding: 5px;">
					...
					<div class="box-footer">
						<#if isread??>
							...
							onclick="window.top.history.back();" />
						<#else>
